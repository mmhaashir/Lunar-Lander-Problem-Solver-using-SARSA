import tensorflow as tf, numpy as np, gymnasium as gymm, random, math, time, matplotlib.pyplot as plt
...
with tf.device('/GPU:0'):
    ...
    number_of_buckets = (5,5,5,5,5,5,2,2)
    ...
    sarsa = SARSA(env,alpha,gamma,epsilon,num_episodes,number_of_buckets,lowerBounds,upperBounds)
